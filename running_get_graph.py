...
y_list_train=to_categorical(y_list_train, 229)
filename_train='./data_chung/data_train_clusterR3.npz'
...
y_list_valid=to_categorical(y_list_valid, 229)
filename_valid='./data_chung/data_valid_clusterR3.npz'
...
y_list_test=to_categorical(y_list_test, 229)
filename_test='./data_chung/data_test_clusterR3.npz'
