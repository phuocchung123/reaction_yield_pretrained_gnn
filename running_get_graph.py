...
data=pd.read_csv('./data_chung/cluster_rl.csv')
data['y']=data['Cluster_R2']
...
y_list_train=to_categorical(y_list_train, 557)
filename_train='./data_chung/data_train_clusterR2.npz'
...
y_list_valid=to_categorical(y_list_valid, 557)
filename_valid='./data_chung/data_valid_clusterR2.npz'
...
y_list_test=to_categorical(y_list_test, 557)
filename_test='./data_chung/data_test_clusterR2.npz'
