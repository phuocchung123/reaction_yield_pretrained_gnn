...
data=pd.read_csv('./data_chung/cluster_rl_class.csv')
data['y']=data['class']
...
filename_train='./data_chung/data_train_cluster_class.npz'
...
filename_valid='./data_chung/data_valid_cluster_class.npz'
...
filename_test='./data_chung/data_test_cluster_class.npz'
