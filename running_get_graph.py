...
y_list_train=to_categorical(y_list_train, 315)
filename_train='./data_chung/data_train_clusterR1.npz'
...
y_list_valid=to_categorical(y_list_valid, 315)
filename_valid='./data_chung/data_valid_clusterR1.npz'
...
y_list_test=to_categorical(y_list_test, 315)
filename_test='./data_chung/data_test_clusterR1.npz'
