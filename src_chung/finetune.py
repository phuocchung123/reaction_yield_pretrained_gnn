...
def finetune(args):
    ...
    train_set = GraphDataset(args.graph_save_path+'data_train_cluster_class.npz')
    ...
    valid_set = GraphDataset(args.graph_save_path+'data_valid_cluster_class.npz')
    ...
    test_set=GraphDataset(args.graph_save_path+'data_test_cluster_class.npz')
