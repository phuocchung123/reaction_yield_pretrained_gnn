...
def finetune(args):
    ...
    train_set = GraphDataset(args.graph_save_path+'data_train_50kunba.npz')
    ...
    valid_set = GraphDataset(args.graph_save_path+'data_valid_50kunba.npz')
    ...
    test_set=GraphDataset(args.graph_save_path+'data_test_50kunba.npz')
